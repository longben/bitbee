...
foreach($data as $i => $d){
    ...
    $this->PhpExcel->setActiveSheetIndex(0)
        ...
        ->setCellValue('E' .$j, $this->requestAction('/regions/getName/'.$d['Department']['region_id']))
        ->setCellValue('F' .$j, $this->requestAction('/regions/getName/'.$d['Department']['city_id']))
        ...
        ->setCellValue('L' .$j,  $this->requestAction('/codes/getNameSet/'.$d['GaDepartmentMeta']['scope']))
