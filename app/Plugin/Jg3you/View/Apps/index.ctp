...
<div class="ct"> 
    <!--最新消息start-->
    <div id="zxxx">
        <div class="more"><a href="/app/page/3" target="_self">更多></a></div>
        <div class="news_list">
            <ul>
    ...
    <!--本园研究start-->
    <div id="byyj">
        <div class="more"><a href="/app/page/5/501" target="_self">更多></a></div>
        <div class="news_list">
            <ul>
...
<div class="ct">
    <div class="left"> 
        ...
        <!--每周安排start-->
        <div id="zmap">
            <div class="moresmall"><a href="/app/page/3/302" target="_self">更多></a></div>
            <ul>
        ...
        <!--国旗下的活动start-->
        <div id="wxts">
            <div class="moresmall"><a href="/app/page/3/303" target="_self">更多></a></div>
            <ul>
                <?php foreach($gqxdhd as $p):?>
                <li class="mzap"><a href="/app/content/<?=$p['Post']['id']?>" title="<?=$p['Post']['post_title']?>"  target="_blank"><?=$p['Post']['post_title']?></a></li>
                <?php endforeach;?>
            </ul>
        </div>
        ...
        <!--每周食谱start-->
        <div id="mzsp">
            <div class="moresmall"><a href="/app/page/8/803" target="_self">更多></a></div>
            <ul>
    ...
    <div class="left705">
        <div> 
            <!--班级博客start-->
            <div id="bjbk">
                <div class="more"><a href="/app/page/7/701" target="_self">更多></a></div>
                <ul>
            ...
            <!--家委会活动start-->
            <div id="jwhhd">
                <div class="more"><a href="/app/page/6/601" target="_self">更多></a></div>
                <ul>
        ...
        <div> 
            <!--保健保育研究start-->
            <div id="bjbyyj">
                <div class="more"><a href="/app/page/8/802" target="_self">更多></a></div>
                <ul>
            ...
            <!--教师随笔start-->
            <div id="jssb">
                <div class="more"><a href="/app/page/5/502" target="_self">更多></a></div>
                <ul>
