...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        echo $this->Html->css(array('/cd4you/css/layout.css?ver=1.0.2', '/cd4you/css/style.css?ver=1.0.0','/cd4you/css/font.css?ver=1.0.0', 'zebra_dialog/zebra_dialog', 'colorbox', 'common'));
