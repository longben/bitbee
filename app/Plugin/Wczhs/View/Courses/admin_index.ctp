<table id="dg" class="easyui-datagrid" style="width:auto;height:auto"
    data-options="url:'/admin/wczhs/courses/json_data.json',fitColumns:true,singleSelect:true,rownumbers:true,pagination:true,toolbar:'#toolbar',pageSize:20">
    <thead>  
        <tr>
...
<script type="text/javascript">
    ...
    function editItem(){
        ...
        */ 
        var _row = '';
        for(var key in row){
            _row = _row + "'data[Course][" + key + "]':row." + key + ",";
        }
        _row = '{' + _row + 't:1}';
