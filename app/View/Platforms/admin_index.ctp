                ...
                <div title="欢迎使用" style="padding:20px;overflow:hidden; color:#395a7b; " >
                    ...
                    <div id="admin_main">
                        <div id="admin_main_2_1">
                            ...
                            <div class="bdr">
                                <!--管理员基本信息-->
                                <p>您好，<strong><span class="font_arial" style="color:#690"><?=$this->Session->read('Auth.User.User.user_nicename')?></span></strong><br/>
                                角色：<?=$this->requestAction('/admin/roles/read/'. $this->Session->read('role'));?> <br/><br/>
